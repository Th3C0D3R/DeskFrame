...
public class Instance : INotifyPropertyChanged
{
	...
	public bool RGBTextTitleBar
	{
		get => _rGBTextTitleBar;
		set
		{
			if (_rGBTextTitleBar != value)
			{
				_rGBTextTitleBar = value;
				OnPropertyChanged(nameof(RGBTextTitleBar), value.ToString());
			}
		}
	}
	...
	public void ToggleRGBTitleText(bool active = false)
	{
		RGBTextTitleBar = active;
	}
